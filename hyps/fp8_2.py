{
    ...
    "quant_hyp": {
        ...
        "grad": {"exp": 5, "man": 2, "rounding": "nearest", "scale": 1/1000},  # gradient quantization (after loss.backwards(), before optim.step())
        ...
        "layers": {"quant": ["conv", "activation"], "except": [81, 93, 105]},  # type of layers to insert a quantization layer after and exceptions
    }
}
