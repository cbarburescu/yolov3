...
class SocialDistancingSystem:
    ...
    def set_roi(self):
        ...
        self.scaled_roi[:, 0] = self.roi[:, 0] * self.scale_roi_w 
        self.scaled_roi[:, 1] = self.roi[:, 1] * self.scale_roi_h
    ...
    def image_to_realworld(self, src):
        if self.auto_perspective:
            ...
            xyz_s = xyz.T
            ret = self.basistransforms.seconds_to_simples(xyz_s)
        else:
