                ...
                if dataset.mode == 'images':
                    ...
                    if not getattr(opt, "separate", False):
                        if vid_path != save_path:  # new video
                            ...
                            h, w = im0.shape[:2]
                            vid_writer = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*opt.fourcc), dataset.fps, (w, h))
...
if __name__ == '__main__':
    ...
    sd_parser = parser.add_subparsers(dest="command").add_parser("socialdistancing")
